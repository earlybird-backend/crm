	...
	<div class="container">
		...
		<div class="nav nav-bar" >
			...
			<ul class="nav nav-bar">			    
				<li>
					<?php if($link == 'supplier/home') {  ?>
						<a class="active" href="javascript:;" >
					<?php }else{ ?>
						<a class="" href="<?php echo base_url('supplier/home'); ?>">
					<?php } ?>
						<?php echo 'Current Dashboard' ?>
						</a>
				</li>
				<li>
					<?php if($link == 'supplier/market') { ?>
						<a class="active" href="javascript:;" >
					<?php }else{ ?>
						<a class="" href="<?php echo base_url('supplier/market'); ?>">
					<?php } ?>
						<?php echo 'Market Manager' ?>
						</a>
				</li>	
				<li>
					<?php if($link == 'supplier/supplier') { ?>
						<a class="active" href="javascript:;" >
					<?php }else{ ?>
						<a class="" href="<?php echo base_url('supplier/supplier'); ?>">
					<?php } ?>
						<?php echo 'Supplier Manage' ?>
						</a>
				</li>
                <li>
