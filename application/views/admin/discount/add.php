...
<h4>Discount Setting</h4>
			<hr/>
<?php echo form_open('admin_bak/plans/adddiscount/',array('name' => 'editpage', 'id' => 'editpage'));?>	
	<table>
		<tr>
		<td width="200">Time Duration </td>
		<td width="746">
		<input type="text" size="6" name="PlanDuration" id="PlanDuration" value="<?php echo set_value('PlanDuration');?>" /> For eg.1,2.
		<?php $DurationType = set_value('DurationType'); ?>
		...
		<td width="725">
		<input type="text"  name="PlanDiscount" id="PlanDiscount" value="<?php echo set_value('PlanDiscount');?>" />(in %age)
