<div id="content">
          <div class="box-element">
            <div class="box-head">
			  ...
			  <b><?php echo anchor('admin_bak/plans/add', 'Add Space Plan');?></b>
            </div>
...
<tbody>
	...
	<tr class="<?php echo $class;?>">
		...
		<td> 
		<a href="<?php echo site_url('admin_bak/plans/edit/'.$v['PlanId'])?>"><img src="<?php echo base_url()?>img/icon_edit.png" alt="edit" title="edit" /></a>
		&nbsp;&nbsp;
		<a href="<?php echo site_url('admin_bak/plans/delete/'.$v['PlanId'])?>" onclick="return deleteRecordConfirm();"><img src="<?php echo base_url()?>img/cross.gif" alt="edit" title="edit" /></a></td>
