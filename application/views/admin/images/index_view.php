    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            */?>
            ...
            echo '</div>';
            ?>
            <?php /* echo anchor('/admin_bak/images/index/'.$content_type.'/'.$content_id, 'Cancel','class="btn btn-default btn-lg btn-block"');*/?>
            <?php echo form_close();?>
        </div>
        <?php
        if(!empty($show_images)) {
            ...
            <div class="col-lg-12">
                ...
                foreach($show_images as $image)
                {
                    ...
                    echo '<td>'.$image->title.' '.anchor('admin_bak/images/edit_title/'.$image->id,'<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>').'</td>';
                    echo '<td>'.$image->file.'</td>';
                    echo '<td>';
                    echo anchor('admin_bak/images/delete/'.$image->id,'<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>','onclick="return confirm(\'Are you sure you want to delete?\')"');
                    echo '</td>';
                    echo '</tr>';
                }
