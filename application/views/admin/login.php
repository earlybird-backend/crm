    ...
    <body class="theme-default page-signin">
        ...
        <div class="signin-container">
            ...
            <div class="signin-form">
                ...
                <?php echo form_open("admin_bak/login"); ?>
                <div class="signin-text">
                    <span>Sign In to your account</span>
                </div> <!-- / .signin-text -->

                <div class="form-group w-icon">
                    <input type="text" name="email" id="email" class="input form-control input-lg" placeholder="Username or email">
                    <span class="fa fa-user signin-form-icon"></span>
                </div> <!-- / Username -->

                <div class="form-group w-icon">
                    <input type="password" name="password" id="password" class="input form-control input-lg" placeholder="Password">
                    <span class="fa fa-lock signin-form-icon"></span>
                </div> <!-- / Password -->

                <div class="form-actions">
                    <input type="submit" value="SIGN IN" class="signin-btn bg-primary sign_btn">
                    <a href="<?php echo site_url('admin_bak/forgotpass') ?>" id="forgot-password-link"  title="Forgot your password?.">Forgot your password?.</a>
                </div> <!-- / .form-actions -->
                <?php echo form_close(); ?>
