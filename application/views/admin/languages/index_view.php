...
<div class="container" style="margin-top:60px;">
    <div class="row">
        <div class="col-lg-12">
            <a href="<?php echo site_url('admin_bak/languages/create');?>" class="btn btn-primary">Add language</a>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12" style="margin-top: 10px;">
            ...
            if(!empty($languages))
            {
                ...
                foreach($languages as $lang)
                {
                    ...
                    echo '</td>';
                    echo '<td>'.anchor('admin_bak/languages/update/'.$lang->id,'<span class="glyphicon glyphicon-pencil"></span>').' '.anchor('admin_bak/languages/delete/'.$lang->id,'<span class="glyphicon glyphicon-remove"></span>').'</td>';
                    echo '</tr>';
                }
