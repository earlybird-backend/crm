        ...
        <div class="col-lg-8">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    echo anchor('admin_bak/master/change-website-status','<span class="glyphicon glyphicon-thumbs-'.(($website->status=='1') ? 'up text-primary':'down text-danger').'" style="font-size: 40px;"></span>','onclick="return confirm(\'Are you sure you want to change the status of the site?\')"');
                ...
                <div class="col-lg-6">
                        ...
                        <tbody>
                            ...
                            if(!empty($banned_ips))
                            {
                                foreach ($banned_ips as $ip)
                                {
                                    ...
                                    echo anchor('admin_bak/master/remove-ip/'.$ip->id,'<span class="glyphicon glyphicon-remove"></span>','onclick="return confirm(\'Are you sure you want to un-ban IP?\')"');
                                    echo '</td>';
                                    echo '</tr>';
                                }
                            }
                    ...
                    <?php
                    echo form_open('admin_bak/master/add-ip');
