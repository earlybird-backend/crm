...
<div class="container" style="margin-top:60px;">
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php echo anchor('/admin_bak/dictionary/index/'.$language_slug, 'Cancel','class="btn btn-default btn-lg btn-block" onclick="if (window.opener && window.opener.open && !window.opener.closed){window.close()};"');?>
            <?php echo form_close();?>
        </div>
    </div>
</div>