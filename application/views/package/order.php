...
<p style="text-align:center;"><?php
    if ($this->session->flashdata('message') && isset($_POST['Buy'])) {
        echo $this->session->flashdata('message');
    }
    ?></p>
...
<?php //echo form_open_multipart('plans/order',array('name' => 'login', 'id' => 'login-form','class'=>'', 'role'=>'form', 'style'=>'display: block;'));  ?>
                ...
                <h2>Order Details</h2>
                  ...
                  <div class="col-xs-12 form-group text-center">     
                        ...
                        <input type="submit" name="submit" id="login-submit" tabindex="4" class="btn btn-login" value="Buy">
    ...
    <div class="container">
        <div class="row display-md-table">
            ...
            <div class="col-md-8 account-information display-md-table-cell">
                <?php echo form_open_multipart('plans/order', array('name' => 'login', 'id' => 'order-form', 'class' => '', 'role' => 'form', 'style' => 'display: block;')); ?>					
...
<div class="text-center mr-t-40">
    <input type="submit" name="submit" id="login-submit" tabindex="4" class="btn btn-rounded btn-border mr-l-10" id="popup-toggle" value="Buy">

<!--    					<a href="#" class="btn btn-rounded btn-border mr-l-10" id="popup-toggle" >Back To My Orders</a>-->
</div>
<?php echo form_close(); ?>
</div>
</div>
