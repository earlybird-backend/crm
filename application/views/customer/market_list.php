		...
		<div class="clearing-status">
			<div class="table-detail">
						...
						<div class="table-body">
							...
							<table id="activeTable" class="display" cellspacing="0">
								...
								<tr>
									...
									<th style="text-align: center;width: 140px;"><span>市场最后计算时间</span></th>
									<th style="text-align: center;width: 120px;"><span>下一付款日</span></th>
									<th style="text-align: center;width: 120px;"><span>可用资金</span></th>
									<th style="text-align: center;width: 120px;"><p>参与发票</p><p>金额/数量</p></th>
                    ...
                    foreach($active as $v){
                        ?>
											<tr id="<?php echo $v['market_id']; ?>"
												...
												<td class="" style="text-align: center;"><?php echo $v['currency_sign'].round($v["invoice"]["payamount"],2). " / ".$v["invoice"]["paycount"] ; ?> </td>
						...
						<div class="table-body" >
							<table id="inactiveTable" class="display" cellspacing="0">
								...
								<tr>
									...
									<th style="text-align: center;width: 70px;"><span>资金计划</span></th>
									<th style="text-align: center;width: 80px;"><span>下一付款日</span></th>
									<th style="text-align: center;width: 100px;"><span>可用资金</span></th>
									<th style="text-align: center;"><p>有效发票</p><p>金额/数量</p></th>
									<th style="text-align: center;width: 80px;"><span>发票明细</span></th>
									<th style="text-align: center;"><span>生成发票</span></th>
								</tr>
								</thead>
                    ...
                    foreach($inactive as $v){
                        ?>
											<tr id="<?php echo $v['market_id']; ?>"
													data-nextpay="<?php echo $v['next_paydate']; ?>" data-code="<?php echo $v['cashpoolcode'] ?>">
												<td class="market_name" style="text-align: center;width: 140px;"><?php echo $v['market_name']; ?> <br> (<?php echo $v['currency_name']; ?>)</td>
												<td style="text-align: center;"><?php echo $v['market_status']; ?></td>
												<td class="plan" style="text-align: center;"><?php echo $v['cash_schedule']; ?></td>
												<td style="text-align: center;width: 80px;"><?php echo $v['next_paydate']; ?></td>
												<td style="text-align: center;">
													<span title="<?php echo $v["cash_plandate"] ; ?> 初始资金 <?php echo $v['currency_sign'].round($v['cash_amount'],2); ?>">
													<?php echo $v['currency_sign'].round($v['cash_available'],2); ?>
													</span>
												</td>
												<td class="" style="text-align: center;"><?php echo $v['currency_sign'].round($v["invoice"]["payamount"],2). " / ".$v["invoice"]["paycount"] ; ?> </td>
												<td class="detail-btn" style="text-align: center;"><button>查看</button></td>
												<td style="text-align: center;">
													<button class="generate" id="<?php echo $v["cashpoolcode"]; ?>" tooltips="生成新数据后，原未成交的发票则会自动为失效">
														<i class="fa fa-copy"></i> 生成
													</button>
												</td>
											</tr>
                        <?php
                ...
                ?>
								...
								<tr>
									<th style="text-align: center;width: 140px;"><span>市场</span></th>
									<th style="text-align: center;width: 70px;"><span>市场状态</span></th>
									<th style="text-align: center;width: 70px;"><span>资金计划</span></th>
									<th style="text-align: center;width: 80px;"><span>下一付款日</span></th>
									<th style="text-align: center;width: 120px;"><span>可用资金</span></th>
									<th style="text-align: center;"><p>有效发票</p><p>金额/数量</p></th>
	...
	<script type="text/javascript">
	  ...
	  $(document).ready(function(){
		  $("button.generate").on('click',function(){
			  ...
			  var __button = $(this);
			  var cashpoolCode = __button.attr("id");

			  __button.attr("disabled", true);

			  $.ajax({
				  type:"POST",
				  url:"market/generateSample/",
				  dataType:"json",
				  data:{"cashpoolCode":cashpoolCode},
