	...
	<div class="container">
		...
		<div class="nav nav-bar" >
			...
			<ul class="nav nav-bar">			    
				<li>
					<?php if($link == 'customer/home') {  ?>
						<a class="active" href="javascript:;" >
					<?php }else{ ?>
						<a class="" href="<?php echo base_url('customer/home'); ?>">
					<?php } ?>
						<?php echo '交易市场' ?>
						</a>
				</li>
				<li>
					<?php if($link == 'customer/market') { ?>
						<a class="active" href="javascript:;" >
					<?php }else{ ?>
						<a class="" href="<?php echo base_url('customer/market'); ?>">
					<?php } ?>
						<?php echo '市场预览' ?>
						</a>
				</li>
				<li>
					<?php if($link == 'customer/customer') { ?>
						<a class="active" href="javascript:;" >
					<?php }else{ ?>
						<a class="" href="<?php echo base_url('customer/customer'); ?>">
					<?php } ?>
						<?php echo '买家管理' ?>
						</a>
				</li>
                <li>
                    <?php if($link == 'customer/supplier') { ?>
                    <a class="active" href="javascript:;" >
                        <?php }else{ ?>
                        <a class="" href="<?php echo base_url('customer/supplier'); ?>">
                            <?php } ?>
                            <?php echo '供应商管理' ?>
                        </a>
                </li>
                <li>
                    ...
                    <a class="active" href="javascript:;" >
                        <?php }else{ ?>
                        <a class="" href="<?php echo base_url('customer/user'); ?>">
                            <?php } ?>
                            <?php echo '用户管理' ?>
                        </a>
                </li>
                <li>
                    ...
                    <a class="active" href="javascript:;" >
                        <?php }else{ ?>
                        <a class="" href="<?php echo base_url('customer/consulting'); ?>">
                            <?php } ?>
                            <?php echo '咨询请求' ?>
                        </a>
                </li>
