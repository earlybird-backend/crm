    ...
    <div class="container">
        ...
        <div class="pull-right hm-wrap">
            <a href="<?php echo site_url('auth'); ?>" class="btn btn-login">登录</a>
             ...
             <a href="<?php echo base_url('enquiry'); ?>" class="btn btn-login active"> 马上注册</a>
             <div class="drop-flag">
                <ul>
                    <li><img src="<?php echo lang_url(); ?>assets/icon/5.svg">
                        <ul class="drop-chlid">                            
                            <li><a href="<?php echo lang_url('english'); ?>"><img src="<?php echo lang_url(); ?>assets/icon/1.svg"></a></li>
                        </ul>
