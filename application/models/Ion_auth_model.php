...
class Ion_auth_model extends CI_Model
{
    ...
    public function activate($id, $code = false)
    {
        ...
        if ($code !== FALSE)
        {
            ...
            $this->trigger_events('extra_where');
            $this->db->update('admin_bak', $data, array('id' => $id));
        }
        else
        {
            $data = array(
    ...
    public function clear_forgotten_password_code($code) {
        ...
        if ($this->db->count_all_results('admin_bak') > 0)
        {
            $data = array(
            ...
            $this->db->update('admin_bak', $data, array('forgotten_password_code' => $code));
    ...
    public function reset_password($identity, $new) {
        ...
        $this->trigger_events('extra_where');
        $this->db->update('admin_bak', $data, array($this->identity_column => $identity));
    ...
    public function change_password($identity, $old, $new)
    {
        ...
        if ($old_password_matches === TRUE)
        {
            ...
            $successfully_changed_password_in_db = $this->db->update('admin_bak', $data, array($this->identity_column => $identity));
    ...
    public function forgotten_password($identity)
    {
        ...
        $this->db->update('admin_bak', $update, array($this->identity_column => $identity));
...
*/
        ...
        $user_data = array_merge($this->_filter_data('admin_bak', $additional_data), $data);

        $this->trigger_events('extra_set');

        $this->db->insert('admin_bak', $user_data);
    ...
    public function users($groups = NULL)
    {
        ...
        if (isset($groups))
        {
            ...
            if (isset($groups) && !empty($groups))
            {
                ...
                $this->db->join(
                    ...
                    $this->tables['users_groups'].'.'.$this->join['users'].'='.'admin_bak'.'.id',
                    'inner'
                );
            }
        ...
        $this->response = $this->db->get('admin_bak');
    ...
    public function update($id, array $data)
    {
        ...
        $data = $this->_filter_data('admin_bak', $data);
        ...
        $this->trigger_events('extra_where');
        $this->db->update('admin_bak', $data, array('id' => $user->id));
    ...
    public function delete_user($id)
    {
        ...
        $this->db->delete('admin_bak', array('id' => $id));
    ...
    public function update_last_login($id)
    {
        ...
        $this->db->update('admin_bak', array('last_login' => time()), array('id' => $id));
    ...
    public function remember_user($id)
    {
        ...
        $this->db->update('admin_bak', array('remember_code' => $salt), array('id' => $id));
