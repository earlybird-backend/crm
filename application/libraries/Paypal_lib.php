...
//		$this->paypal_url = 'https://www.paypal.com/cgi-bin/webscr';
	...
	function image($file)
	{
		...
		$this->submit_btn = '<input type="submit" name="add" value="Submit" border="0" />';
	}
	...
	function paypal_auto_form() 
	{
		...
		$str = $this->image('submit_btn.gif');
		
		//echo '<html>' . "\n";
		//echo '<head><title>Processing Payment...</title></head>' . "\n";		
		$str .= '<p>Please wait, your order is being processed and you will be redirected to the paypal website.</p>' ;
		$str .= '<p>If you are not automatically redirected to paypal within 5 seconds then click on Submit button.</p>';
		$str .= $this->paypal_form('paypal_auto_form');
		$str .= '<script>document.forms[\'paypal_auto_form\'].submit();</script>';
		return $str;
		//echo '</body></html>';
	}
	...
	function validate_ipn()
	{
		...
		$fp = fsockopen('ssl://www.sandbox.paypal.com',443,$err_num,$err_str,30); //check with sandbox
		
		//$fp = fsockopen('ssl://www.paypal.com',443,$err_num,$err_str,30); //check with live
		...
		{
			//mail("sagar.singh@site.com","Testing IPN verified area",$this->ipn_response);
