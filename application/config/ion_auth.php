...
/*
 ...
 |
 | If you are using Bcrypt the Admin password field also needs to be changed in order to login as admin_bak:
...
$config['admin_email']                = "admin_bak@example.com"; // Admin Email, admin_bak@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin_bak';             // Default administrators group, use name
