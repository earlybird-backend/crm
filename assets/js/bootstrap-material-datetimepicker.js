   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                  ...
                  var yearHtml =
                      ...
                      '<div><a href="javascript:void(0);" class="btn btn-default dtp-select-year-range before" style="margin: 0;"><i class="fa fa-chevron-right"></i></a></div>' +
                      yearPicker +
                      '<div><a href="javascript:void(0);" class="btn btn-default dtp-select-year-range after" style="margin: 0;"><i class="fa fa-chevron-left"></i></a></div>' +
                      '</div>';
